...
@section("fourm_title")
   منتديات مدينتي | {{ $fourm->four_title }}
@endsection
  


 @section("talbar2")
 <div style=" height: 49.75px;
...
margin-bottom: 13px;
margin-top: -59px;
margin: -59px 230px 13px 89px;" class="sticky-wrapper" id="sticky-wrapper" style="">
    ...
    font-size:13pt;" class="tabbar">
            ...
            <div class="modal-dialog" role="document">
                ...
                <form action="{{ url('locfourmpost')}} " method="POST" enctype="multipart/form-data">
               @csrf
...
<div class="col-lg-7 col-md-6 sm-6">
...
color: #b3b9bf;
margin-top: 5px;
font-weight: bold;" class="title">المنتديات العامة ... <i style="background-color: rgb(255, 255, 255);padding: 8px;border-radius: 15px;  " class="badge"></i></span>
